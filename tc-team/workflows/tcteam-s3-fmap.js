...
- **아이템 실명 병기 보존**: leaf 에 \`(예: 세공석)\`·\`(예: 제작 재료 임시 명칭(Index 301010001))\` 처럼 **아이템 실명 병기**가 있으면 문장에 **그대로 옮긴다**. 지우거나 일반명사로 되돌리지 말 것 — 테스터가 무엇을 집어야 하는지가 이 괄호에만 있다(결정론 사전 item_dict.json 산출). 병기가 없는 leaf 에 네가 실명을 **새로 만들어 넣는 것도 금지**(설계 영역).
