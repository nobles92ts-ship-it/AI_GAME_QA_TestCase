...
## 기본 정보
- **스프레드시트**: `https://docs.google.com/spreadsheets/d/{ALPHA_SPREADSHEET_ID}`
- **스프레드시트 ID**: `{ALPHA_SPREADSHEET_ID}`
- **대시보드 시트**: 첫 번째 시트 (시트명 자동 감지)
- **스크립트**: `{PROJECT_ROOT}/scripts/util/update_dashboard_alpha.js`
