...
|------|------------|---------|---------|
| 마스터 (DX 전체) | `{{MASTER_DASHBOARD_ID}}` | `update_dashboard.js` | [master.md](./master.md) |
| 통합 TC (구형) | `{{INTEGRATION_TC_ID}}` | `update_dashboard_alpha.js` | [alpha.md](./alpha.md) |
| Game QA TC | `{{GAME_QA_ID}}` | `update_dashboard_gameqa.js` | — |
